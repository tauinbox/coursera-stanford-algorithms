...
class Karger
  ...
  def initialize(filedata, number_of_iterations = 30)
    @mincut = iterate(filedata, number_of_iterations)
  end
...
result = Karger.new(input_file)

puts "\n-----------------------------------------------------------"
puts "The minimum cut is: #{result.mincut}"
puts "-----------------------------------------------------------\n"
